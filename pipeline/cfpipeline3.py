...
def cfpipeline3():
    ...
    parser.add_argument("-D", "--optical-duplicate-distance", help="maximum pixel distance between two cluster to be considered optical duplicates.", default="varscan,vardict")
    ...
    pipe(["elduderino", "--output", deduplicated_fastq,
                        ...
                        "--umi", args.umi,
                        "--optical-duplicate-distance", args.optical_duplicate_distance,
                        sorted_sam])
